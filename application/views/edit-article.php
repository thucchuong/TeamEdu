...
<head>
    ...
    <title><?= !empty($this->lang->line('label_edit_article')) ? $this->lang->line('label_edit_article') : 'Edit Article'; ?> &mdash; <?= get_compnay_title(); ?></title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1><?= !empty($this->lang->line('label_edit_article')) ? $this->lang->line('label_edit_article') : 'Edit Article'; ?></h1>
                    ...
                    <div class="section-body">
                        <div class="row mt-sm-4">
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        <form action="<?= base_url('knowledgebase/edit') ?>" id="create_article">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="title" type="text" class="form-control" name="title" value=<?= $article[0]['title'] ?> placeholder=<?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title' ?>>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="asterisk">*</span>
                                                <textarea name="description" id="add_article" class="form-control article" placeholder="<?= !empty($this->lang->line('label_article_description')) ? $this->lang->line('label_article_description') : 'Article Description' ?>" data-height="150"><?= output_escaping(str_replace('"', '', $article[0]['description']), "'") ?></textarea>
                                            </div>
