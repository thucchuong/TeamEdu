...
<head>
    ...
    <title><?= !empty($this->lang->line('label_add_allowance')) ? $this->lang->line('label_add_allowance') : 'Add Allowance'; ?> &mdash; <?= get_compnay_title(); ?></title>
    <?php
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1><?= !empty($this->lang->line('label_add_allowance')) ? $this->lang->line('label_add_allowance') : 'Add Allowance'; ?></h1>
                        <div class="section-header-breadcrumb">
                            ...
                            <?php if (check_permissions("payslips", "create")) { ?>
                                <i class="btn btn-primary btn-rounded no-shadow" id="modal-add-allowance" data-value="add"><?= !empty($this->lang->line('label_add_allowance')) ? $this->lang->line('label_add_allowance') : 'Add Allowance'; ?></i>
                            <?php } ?>
                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        <table class='table-striped' id='allowances_list' data-toggle="table" data-url="<?= base_url('payslip/get_allowances_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-options='{ "fileName": "Allowances-list" }' data-query-params="queryParams1">
                                            <thead>
                                                <tr>
            ...
            <?php } ?>
            <div class="modal-edit-allowance"></div>
            <?= form_open('payslip/edit_allowance', 'id="modal-edit-allowance-part"', 'class="modal-part"'); ?>
            <div id="modal-title" class="d-none"><?= !empty($this->lang->line('label_edit')) ? $this->lang->line('label_edit') : 'Edit'; ?><?= !empty($this->lang->line('label_allowance')) ? ' ' . $this->lang->line('label_allowance') : ' Allowance'; ?></div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?= form_input(['name' => 'allowance_name', 'placeholder' => !empty($this->lang->line('label_name')) ? $this->lang->line('label_name') : 'Name', 'class' => 'form-control', 'id' => 'update_name']) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label><?= !empty($this->lang->line('label_amount')) ? $this->lang->line('label_amount') : 'Amount'; ?></label><span class="asterisk"> *</span>
                        <div class="input-group">
                            <?= form_input(['type' => 'number', 'name' => !empty($this->lang->line('label_amount')) ? $this->lang->line('label_amount') : 'Amount', 'placeholder' => 'Amount', 'class' => 'form-control', 'min' => 0, 'id' => 'update_amount']) ?>
                        </div>
                    </div>
                </div>
            </div>
